...
const ProfileDetails = () => {
  ...
  return (
    <div className="flex justify-center gap-5 py-10">
      ...
      <section className="rounded-lg bg-gray-50 shadow-sm p-7 sm:max-w-sm sm:p-4 sm:pb-12 h-[50%]">
        <img
        ...
        <div>
          <div className="flex justify-between my-3">
            <div className="">
              ...
              <p className="italic text-gray-500">{singleProfile?.email}</p>
            </div>
            <div className="">
              <p className="font-bold text-gray-50 bg-purple-700 px-2 py-1 rounded-full">
          ...
          <br />
          <p className="text-gray-600 font-semibold ">{singleProfile?.intro}</p>
      ...
      <section className="bg-gray-50 hidden md:block relative max-w-2xl rounded-lg lg:justify-self-end">
